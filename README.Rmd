...
* **Rcode_Killdeer_foraging.pdf** contains the code for all analyses, which can be implemented after downloading the datasets provided in the `Data_files` folder.
* **`Data_files`** contains the following datasets and should be placed in a subfolder of the working directory called `Data_files`
